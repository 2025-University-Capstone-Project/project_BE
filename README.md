...
Y.P.T는 로제의 '아파트(APT.)' 트렌드에서 영감을 받아 기획된 프로젝트로, 야구 팬들의 열정적인 기록과 소통을 위한 '디지털 아파트' 역할을 합니다. 2025 KBO 리그 데이터를 기반으로 실시간 경기 정보와 응원 팀에 맞춘 개인화 테마를 제공하며, 직관 일지 기능으로 팬들의 소중한 추억을 기록합니다. 또한 야구 퀴즈와 승부 예측 등 게이미피케이션 요소를 도입하여 신규 팬들도 쉽고 재미있게 즐길 수 있는 참여형 올인원 플랫폼을 지향합니다.
...
### 4. Personalization & Fan Engagement (개인화 및 팬 참여)
- **Team Themes**: 사용자가 응원하는 구단에 따라 애플리케이션 테마가 변경되는 개인화 경험을 제공합니다.
- **Gamification**: 야구 퀴즈 및 승부 예측 기능을 통해 신규 팬들의 진입 장벽을 낮추고 흥미를 유발합니다.
